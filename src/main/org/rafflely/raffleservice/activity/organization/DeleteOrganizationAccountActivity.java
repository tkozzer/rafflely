...
public class DeleteOrganizationAccountActivity implements RequestHandler<String, String> {
    private final OrganizationDao organizationDao;
    private final OrganizerDao organizerDao;
    private final EventDao eventDao;

    @Inject
    public DeleteOrganizationAccountActivity(OrganizationDao organizationDao, OrganizerDao organizerDao, EventDao eventDao) {
