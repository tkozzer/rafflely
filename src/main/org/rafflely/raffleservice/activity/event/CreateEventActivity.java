...
public class CreateEventActivity implements RequestHandler<String, String> {
    private final EventDao eventDao;
    private final OrganizationDao organizationDao;
    private final RaffleDao raffleDao;

    @Inject
    public CreateEventActivity(EventDao eventDao, OrganizationDao organizationDao, RaffleDao raffleDao) {
