...
public class GetEventActivity implements RequestHandler<String, String> {
    private final EventDao eventDao;
    private final OrganizationDao organizationDao;
    private final RaffleDao raffleDao;

    @Inject
    public GetEventActivity(EventDao eventDao, OrganizationDao organizationDao, RaffleDao raffleDao) {
