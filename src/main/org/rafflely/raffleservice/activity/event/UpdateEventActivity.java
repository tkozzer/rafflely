...
public class UpdateEventActivity implements RequestHandler<String, String> {
    private final EventDao eventDao;
    private final OrganizationDao organizationDao;
    private final RaffleDao raffleDao;

    @Inject
    public UpdateEventActivity(EventDao eventDao, OrganizationDao organizationDao, RaffleDao raffleDao) {
