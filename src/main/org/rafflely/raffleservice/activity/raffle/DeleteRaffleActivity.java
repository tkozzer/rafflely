...
public class DeleteRaffleActivity implements RequestHandler<String, String> {
    private final RaffleDao raffleDao;
    private final EventDao eventDao;
    private final RaffleItemDao raffleItemDao;

    @Inject
    public DeleteRaffleActivity(RaffleDao raffleDao, EventDao eventDao, RaffleItemDao raffleItemDao) {
