...
public class UpdateRaffleItemActivity implements RequestHandler<String, String> {
    private final RaffleDao raffleDao;
    private final RaffleItemDao raffleItemDao;

    @Inject
    public UpdateRaffleItemActivity(RaffleDao raffleDao, RaffleItemDao raffleItemDao) {
